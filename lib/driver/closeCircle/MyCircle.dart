...
class MyCirclePage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return MyCirclePageState();
  }
}

class MyCirclePageState extends State<MyCirclePage> {

  Future<List<CloseCircleUser>> futureAllCloseCircle;
  @override
  void initState() {
    super.initState();
    futureAllCloseCircle = fetchAllAcceptedCircle();
  }
