...
class RequestedPageState extends State<RequestedPage> {

  Future<List<CloseCircleUser>> futureAllRequestedCircle;
  @override
  void initState() {
    super.initState();
    futureAllRequestedCircle = fetchAllRequestedCircle();
  }
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FutureBuilder(
        ...
        future: futureAllRequestedCircle,
      ),
    );
  }
}